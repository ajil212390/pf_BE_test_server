...
class Conversation(models.Model):
    ...
    enduser = models.ForeignKey(EndUser, models.DO_NOTHING, db_column='endsuerid', null=True, blank=True)
    executive = models.ForeignKey('SupplierExecutive', models.DO_NOTHING, db_column='executiveid', null=True, blank=True)
    conversation_type = models.CharField(max_length=20, default='customer')
...
class SupplierOrderItem(models.Model):
    ...
    supplier_product = models.ForeignKey('SupplierProduct', on_delete=models.SET_NULL, null=True, blank=True, db_column='supplierproductid')
