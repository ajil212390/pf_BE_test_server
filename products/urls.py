...
urlpatterns = [
    ...
    path('chat/conversations/company/<int:company_id>/executives/', get_company_executive_conversations),
    path('chat/conversations/enduser/<int:enduser_id>/', get_enduser_conversations),
    path('chat/conversations/executive/<int:executive_id>/', get_executive_conversations),
    path('chat/<int:conversation_id>/messages/', get_conversation_messages),
    path('chat/conversations/<int:conversation_id>/details/', get_conversation_details),
    path('chat/conversations/details/', get_conversation_details),
    ...
    path('supplier/executives/<int:executive_id>/delete/', delete_supplier_executive),
